...
public enum DataSources {
    BUE(
        ...
        csv -> new Neighbourhood(csv[0], Long.parseLong(csv[1]))
    ),
    VAN(
    ...
    DataSources(final Function<String[], Tree> treeBuilder, final Function<String[], Neighbourhood> neighbourhoodBuilder) {
